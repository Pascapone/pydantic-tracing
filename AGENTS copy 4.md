...
The virtual environment for python (`./python-workers/.venv`) must be used for running python and workers. If you run python you should always use this environment.
